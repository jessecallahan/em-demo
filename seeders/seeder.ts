...
export class MySeeder extends Seeder {
    async run(em: EntityManager): Promise<void> {
        ...
        // const teamDto = {
        //     homeGames: [
        //         {home: rainiers2, away: mariners2}
        //     ],
        // };
        // wrap(rainiers2).assign(teamDto);


        // * What is a reference?

        const thirdTeam = em.getReference(Team, 1);
        // em.remove(thirdTeam);
        ...
        const pitch = new Pitch('strike', 'fastball');
        await em.persist(pitch).flush();
        ...
        const gameDto = {
            ...
            pitches: [foundPitch.id]
        };
        em.create(Game, gameDto)
